...
public class Tabuleiro {
	...
	public void movePeca(String Movimento) {
	    ...
	    System.out.println("Meu tabPeao[Csource.linha][Csource.coluna].P é : " + tabPeao[Csource.linha][Csource.coluna].P);
	...
	public boolean movePeaoPreto(PecaPeao Peao, Coordenada Ctarget) {
		...
		System.out.println("Meu Peao.coordenada.linha é : "+ Peao.coordenada.linha);	
		System.out.println("Meu Ctarget.linha é : "+ Ctarget.linha);
		System.out.println("Meu Peao.coordenada.coluna é : "+ Peao.coordenada.coluna);	
		System.out.println("Meu Ctarget.coluna é : "+ Ctarget.coluna);
		...
		if (Peao.coordenada.linha == Ctarget.linha && Peao.coordenada.coluna == Ctarget.coluna) {
			...
			if (Peao.TestaPeao("Movimento para Sudoeste")) { 
				...
				if (Peao.TestaTabuleiro("Movimento para Sudoeste")) {
					...
					if (Peao.P == 'B' && StatusMovimento) { // casa atras para comer
						CapturaOponente();
						return (true);
					} 
				}
